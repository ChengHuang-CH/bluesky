...
def save():
    ...
    sensors = {'camera09': {'model': 'camera',
                            'extrinsic': {'latitude': pole09[0], 'longitude': pole09[1], 'altitude': 8.0,
                                          'pitch': 0, 'yaw': 210, 'roll': 0},
                            'intrinsic': {'img_width': 1920, 'img_height': 1080, 'fov': 40, 'range': None}
                            },  # 52.066889, -0.628129'
               'camera10': {'model': 'camera',
                            'extrinsic': {'latitude': pole10[0], 'longitude': pole10[1], 'altitude': 8.0,
                                          'pitch': 0, 'yaw': 200, 'roll': 0},
                            'intrinsic': {'img_width': 1920, 'img_height': 1080, 'fov': 40, 'range': None}
                            },  # 52.066889, -0.628129
               'camera12': {'model': 'camera',
                            'extrinsic': {'latitude': pole12[0], 'longitude': pole12[1], 'altitude': 8.0,
                                          'pitch': 0, 'yaw': 190, 'roll': 0},
                            'intrinsic': {'img_width': 1920, 'img_height': 1080, 'fov': 40, 'range': None}
                            },
               'camera13': {'model': 'camera',
                            'extrinsic': {'latitude': pole13[0], 'longitude': pole13[1], 'altitude': 8.0,
                                          'pitch': 0, 'yaw': 160, 'roll': 0},
                            'intrinsic': {'img_width': 1920, 'img_height': 1080, 'fov': 40, 'range': None}
                            },
               'camera14': {'model': 'camera',
                            'extrinsic': {'latitude': pole14[0], 'longitude': pole14[1], 'altitude': 8.0,
                                          'pitch': 0, 'yaw': 155, 'roll': 0},
                            'intrinsic': {'img_width': 1920, 'img_height': 1080, 'fov': 40, 'range': None}
                            },
               'camera17': {'model': 'camera',
                            'extrinsic': {'latitude': pole17[0], 'longitude': pole17[1], 'altitude': 8.0,
    ...
    with open('../../../data/osm/vertiport_sensor_config.json', 'w') as f:
        json.dump(sensors, f)
...
def load():
    ...
    @return:
    """
    with open('../../../data/osm/vertiport_sensor_config.json', 'r') as data_file:
